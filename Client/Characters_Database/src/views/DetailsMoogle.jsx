  ...
  async function fetchOriginDescription(characterName) {
    try {
      const genAI = new GoogleGenerativeAI(
        "AIzaSyCZP4JN-TYoyNarV2v7ZCdHU35l_dlffAU"
      );
  ...
  async function bioCharacter() {
    try {
      ...
      const { data } = await axios.get(
        `https://www.moogleapi.com/api/v1/characters/${id}`
      );
      console.log(data);
      ...
      <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          <div className="max-w-lg">
            ...
            <p className="text-base font-extrabold text-black sm:text-base">
              Name: {character.name || "Unknown"}
            </p>
            <p className="text-base font-extrabold text-black sm:text-base">
              Japanese Name: {character.japaneseName || "Unknown"}
            </p>
            <p className="text-base font-extrabold text-black sm:text-base">
